 ...
 */
public class BasicNerPipeline_DE
{
	public static void main(String[] args) throws Exception
	{

		Logger logger = Logger.getLogger(BasicNerPipeline_DE.class.toString());
		...
		CollectionReaderDescription reader = createReaderDescription(BaseCasReader.class,
				...
				BaseCasReader.PARAM_QUERY,"{'meta.source.inLanguage':'de','processing.available_data': {'$ne': 'text_nerl'}}",
		...
		AnalysisEngineDescription key = createEngineDescription(KeyPhraseAnnotator.class,
				KeyPhraseAnnotator.PARAM_LANGUAGE, "de",
